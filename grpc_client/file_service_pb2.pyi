...
class File(_message.Message):
    __slots__ = ["bucket", "chunk_data", "content_type", "filename", "last_modified"]
    BUCKET_FIELD_NUMBER: _ClassVar[int]
    CHUNK_DATA_FIELD_NUMBER: _ClassVar[int]
    ...
    filename: str
    last_modified: str
    def __init__(self, chunk_data: _Optional[bytes] = ..., bucket: _Optional[str] = ..., filename: _Optional[str] = ..., last_modified: _Optional[str] = ..., content_type: _Optional[str] = ...) -> None: ...
...
class MetaData(_message.Message):
    __slots__ = ["bucket", "content_type", "filename", "hash", "last_modified", "size"]
    BUCKET_FIELD_NUMBER: _ClassVar[int]
    CONTENT_TYPE_FIELD_NUMBER: _ClassVar[int]
    FILENAME_FIELD_NUMBER: _ClassVar[int]
    ...
    last_modified: str
    size: float
    def __init__(self, bucket: _Optional[str] = ..., filename: _Optional[str] = ..., hash: _Optional[str] = ..., last_modified: _Optional[str] = ..., size: _Optional[float] = ..., content_type: _Optional[str] = ...) -> None: ...
